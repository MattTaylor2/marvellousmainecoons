...
<body>
  ...
  <nav class="admin-nav">
    <ul>
      <li><a href="admin/add-kitten.php">Add Kitten</a></li>
      <li><a href="admin/media_manager.php">Manage Media</a></li>
      <li><a href="admin/text_manager.php">Manage Text</a></li>
      <li><a href="admin/users.php">Manage Users</a></li>
      <li><a href="admin/manage_inquiries.php">View Inquiries</a></li>
      <li><a href="admin/feedback_moderation.php">Moderate Feedback</a></li>
      <li><a href="admin/reset_password.php">Reset Passwords</a></li>
